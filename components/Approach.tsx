  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 px-10">
        ...
        <h2
          className="dark:text-white text-center text-4xl font-bold opacity-0 group-hover/canvas-card:opacity-100
        ...
        <ul
          className="list-disc text-2xl font-semibold opacity-0 group-hover/canvas-card:opacity-100
  relative z-10 mt-6 group-hover/canvas-card:text-white text-left
  group-hover/canvas-card:-translate-y-2 transition duration-200 pl-8"
          style={{ color: "#E4ECFF" }}
        >
